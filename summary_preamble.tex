...
\newcommand{\TitleRule}{\color{codeblue!85!black} \rule{\linewidth}{15pt} \vspace{-90pt}\linebreak \HorRule \linebreak}
...
\pretitle{\vspace{-80pt} \fontsize{30}{50} \usefont{OT1}{phv}{b}{n} \TitleRule \color{Black}} % Horizontal rule before the title
	...
	\title{NLP4Web Summary} % The title
...
%[] % Shape
{\color{codeblue!85!black} \titlerule[15pt] \color{White} \titlerule[7pt] \color{Black} \titlerule[2pt] \SectionFont} % Format
{\thesection} % Label
{1em} % Seperator
...
\tcbset{
    ...
    definitionbox/.style={
        bluebox % Change these to the colors you want your defboxes to be
    },
    mathematicsbox/.style={
        orangebox % Change these to the colors you want your mathboxes to be
    },
    codingbox/.style={
        redbox % Change these to the colors you want your code boxes to be
    }
}
